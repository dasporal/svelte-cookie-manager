import { type CookieCategories } from '$lib/types.js';
import { trackers } from './trackers.js';

export const getBlockedHosts = (preferences: CookieCategories | null): string[] => {
	if (!preferences) {
...
export const getBlockedKeywords = (preferences: CookieCategories | null): string[] => {
	if (!preferences) {
		// If no preferences set, block everything
